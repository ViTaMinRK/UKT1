...
/* Задачи для низкоуровневого опроса перефирийного оборудования */
static void vAIRead(void *pvParameters);
static void vDIRead(void *pvParameters);

portBASE_TYPE ReadCnf(void);
